...
export const SYSTEM_PERMISSIONS = [
  ...
  { id: "pages.create", category: "workspace", label: "Create Pages", description: "Create pages in workspace" },
  { id: "pages.publish", category: "workspace", label: "Publish Pages", description: "Publish pages as apps" },
  { id: "pages.schedule", category: "workspace", label: "Schedule Tasks", description: "Schedule pages to run on cron" },
  { id: "notebooks.use", category: "workspace", label: "Use Notebooks", description: "Create and use Jupyter notebooks" },
  { id: "tasks.view", category: "tasks", label: "View Tasks", description: "View all scheduled tasks" },
  { id: "tasks.manage", category: "tasks", label: "Manage Tasks", description: "Enable/disable/remove any schedule" },
...
const DEFAULT_ROLES = [
  ...
  },
  {
    ...
    permissions: [
      ...
      "pages.create", "pages.publish", "pages.schedule", "notebooks.use",
      "tasks.view",
    ],
  },
  {
